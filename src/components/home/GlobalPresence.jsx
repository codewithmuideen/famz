...
import { regions as fallbackRegions } from "../../constants/locations";
...
export default function GlobalPresence() {
  ...
  const { content } = useSiteContent("home", "globalPresence", defaults);
      ...
      <div className="container-page grid gap-12 lg:grid-cols-2 lg:gap-16">
        <div className="flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-4">
            {regions.map((r) => (
              <li key={r.id || r.region} className="flex items-start gap-3 border-t border-line pt-4 first:border-t-0 first:pt-0">
